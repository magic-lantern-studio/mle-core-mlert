...
public class MleDppReader
{
     ...
     * The file will be opened in the specified <b>mode</b>.
     * 
	...
	{
	    // Initialize Digital Playprint book keeping structures.
        ...
        {
			throw new MleDppException("Unable to open Digital Playprint " + filename + ".");
        }
	}
     ...
     * Set swap mode.
     * 
     * @param swap If <b>true</b> then byte ordering will be swapped on
     * read.
     */
     ...
     * Get the swap mode.
     * 
     * @return <b>true</b> will be returned if byte ordering is swapped
     * on read.
     */
        ...
        throws MleDppException
    {
        ...
        MleDppUtil.dppDescend(m_file,formInfo,null,type);
    ...
    protected boolean end() throws MleDppException
    {
        ...
        MleDppUtil.dppAscend(m_file,formInfo,0);
     ...
     * 
     * @return A reference to the <code>RandomAccessFile</code> is returned.
     */
