...
public class MleDppInput extends MleDppReader
{
     ...
     * 
     * @return <code>true</code> is returned if the IFF 'hdr' chunk is
     * successfully read. Otherwise, <code>false</code> is returned.
     */
     ...
     * can not be successfully read from the Digital Playprint.
     * 
     * @return <code>true</code> is returned if the IFF 'grp' chunk is
     * successfully read. Otherwise, <code>false</code> is returned.
     */
     ...
     * can not be successfully read from the Digital Playprint.
     * 
     * @return <code>true</code> is returned if the IFF 'MRFL' LIST chunk is
     * successfully read. Otherwise, <code>false</code> is returned.
     */
     ...
     * 
     * @return <code>true</code> is returned if the IFF 'MRFL' LIST chunk is
     * successfully processed. Otherwise, <code>false</code> is returned.
     */
     ...
     * can not be successfully read from the Digital Playprint.
     * 
     * @return <code>true</code> is returned if the IFF 'mref' chunk is
     * successfully read. Otherwise, <code>false</code> is returned.
     */
     ...
     * can not be successfully read from the Digital Playprint.
     * 
     * @return <code>true</code> is returned if the IFF 'set' chunk is
     * successfully read. Otherwise, <code>false</code> is returned.
     */
     ...
     * can not be successfully read from the Digital Playprint.
     * 
     * @return <code>true</code> is returned if the IFF 'scn' chunk is
     * successfully read. Otherwise, <code>false</code> is returned.
     */
     ...
     * can not be successfully read from the Digital Playprint.
     * 
     * @return <code>true</code> is returned if the IFF 'toc' chunk is
     * successfully read. Otherwise, <code>false</code> is returned.
     */
     ...
     * 
     * @throws MleDppException This exception is thrown if the method is unable
     * to seek to the specified <code>tocOffset</code> location in the Digital
     * Playprint.
     */
