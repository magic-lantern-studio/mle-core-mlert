...
public class MleDppUtil
{
     ...
     */
    public static boolean dppAscend(RandomAccessFile file, MleDppChunkInfo info, int flags)
     ...
     */
    static boolean seek(RandomAccessFile file,long offset, int whence)
        throws IOException
    {
        if (whence == SEEK_SET)
            file.seek(offset);
     ...
     */
    static long tell(RandomAccessFile file)
        throws IOException
    {
     ...
     * be processed.
     */
    protected static MleDppChunkInfo readChunk(RandomAccessFile file)
        throws MleDppException
    {
     ...
     * <code>RandomAccessFile</code> will be pointing to the beginning of the data section in the found
     * chunk.
     * 
     * @throws MleDppException This exception is thrown if the input arguments are invalid,
     * or if an error occurs while processing the Digital Playprint.
     */
    public static MleDppChunkInfo dppDescend(RandomAccessFile file,MleDppChunkInfo info,MleDppChunkInfo pinfo,int flags)
        throws MleDppException
    {
	 ...
	 */
    public static int dppCheckFormat(RandomAccessFile file)
	     throws MleDppException
	{
	    int chunkFileTag;
	    long offset;
