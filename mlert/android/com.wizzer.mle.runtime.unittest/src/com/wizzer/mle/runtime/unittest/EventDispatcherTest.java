...
public class EventDispatcherTest extends TestCase
{
    ...
    protected class State extends MleEventCallback
    {
    	...
    	public boolean dispatch(MleEvent event,Object clientdata)
    	{
    	    ...
    	    // Do some work.
 		    Log.i(MleTitle.DEBUG_TAG,"Executing Callback: " + m_name + "\n" +
	...
	public void testImmediateMode()
	{
	    ...
	    Log.i(MleTitle.DEBUG_TAG,"*** Test installEventCB() ***");
	    this.mainloop();
	}
	...
	public void testDelayedMode()
	{
	    ...
	    Log.i(MleTitle.DEBUG_TAG,"*** Test dispatchEvents() ***");
	...
	public void testDisableEventCB()
	{
	    ...
	    // Process the state machine.
	    Log.i(MleTitle.DEBUG_TAG,"*** Test disableEventCB() ***");
	    this.mainloop();
	}
	...
	public void testDisableEvent()
	{
	    ...
	    // Process the state machine.
	    Log.i(MleTitle.DEBUG_TAG,"*** Test disableEvent() ***");
	    this.mainloop();
	}
	...
	public void testFlush()
	{
	    ...
	    Log.i(MleTitle.DEBUG_TAG,"*** Test flush() ***");
	    m_machine.dispatchEvents();
	}
	...
	public void testPrioritizedCB()
	{
	    ...
	    Log.i(MleTitle.DEBUG_TAG,"*** Test Prioritized Callbacks ***");
	    m_machine.dispatchEvents();
	}
}
